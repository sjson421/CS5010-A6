...
public class ImagePlotter {
  ...
  /**
   * Initializes an ImagePlotter with default height and point size.
   */
  public ImagePlotter() {
    reset();
    pointSize = 3;
   ...
   *
   * @param x1 X of first point in line
   * @param y1 Y of first point in line
   * @param x2 X of second point in line
   * @param y2 Y of second point in line
   */
   ...
   *
   * @param xmin Dimension minimum x
   * @param xmax Dimension maximum x
   * @param ymin Dimension minimum y
   * @param ymax Dimension maximum y
   */
   ...
   * @throws IOException Thrown when invalid input.
   */
